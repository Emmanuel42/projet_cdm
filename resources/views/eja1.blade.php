...
@section('content')
	...
	<div class="col justify-content-center">
		...
		<div class="form">
    		<form action="{{ action('EnigmeControllerJa@validE1') }}" method="POST">
        		{{ csrf_field() }}
        		<label for="enigme1ja">Lorsque vous avez trouvé le mot, inscrivez-le ci-dessous en MAJUSCULES puis validez pour passer à l'énigme suivante.</label><br>
    			<input id="enigme1ja" type="text" name="enigme1ja" placeholder="Votre réponse" style="margin-right:5px; margin-bottom:5px">
