    ...
    <body style="background-color: #e6f3ff">
    	<div class="container" style="margin: 0, auto">
    		<div class="col justify-content-center">
    	 		...
    	 		<div> 
    	 			<h1 class="titre" style="text-align: center; padding-bottom: 5px; text-decoration: #428bca underline">Enigme de la cour des matières</h1>
    	 		</div>  
    	 		...
    	 		<div class="consignes" style="text-align: center">
        			...
        			<div class="col justify-content-center">
    	 			...
    	 			<div>
    	 				...
    	 				<img src="img/plancdm3.png" class="img-fluid border border-primary" style="padding:30px; border-width: 3px ! important;" alt="Plan de la cour des matières" /></img>
