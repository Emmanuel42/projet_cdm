...
<html lang="fr">
    ...
    <body>
    	 ...
    	 <div> <h1 class="titre" style="text-align: center; padding-bottom: 20px; text-decoration: #428bca underline">Enigme cour des matières</h1></div>  
    	 ...
    	 <div class="plan" style="text-align: center; margin-bottom:20px">
        	...
        	<div class="contenu" style="text-align: center; margin-bottom:20px">
    	 	...
    	 	<div>
    	 		...
    	 		<img src="img/plancdm.png" class="img-fluid border border-primary" style="padding:50px; border-width: 3px ! important;" alt="Plan de la cour des matières" /></img>
